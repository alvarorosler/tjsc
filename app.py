...
data = {
    ...
    "Julgamentos": [
        ...
        17149, 12267, 24319, 21258, 25502, 23240, 24444, 25194, 26736, 23724, 24551
    ],
    "Saldo de Entradas": [
        ...
        14796, 10956, 19739, 19046, 23512, 20710, 20440, 23236, 21525, 22294, 22175
    ],
    "Sentenças_JE": [
        ...
        16360, 15832, 23838, 25241, 27921, 27249, 28474, 32874, 29293, 30977, 31149
    ],
    "Sentenças_1G": [
        ...
        74222, 72113, 72503, 80012, 78849, 73568, 73559, 81543, 79823, 77201, 95247
    ]
}
